...
const CACHE='belm-app-v291-machinery-admin-panel';
const SHELL=['/customer-app.html','/customer-app.css?v=211-bug-audit','/customer-app.js?v=289-friendly-identities','/password-visibility.css?v=209-eye-toggle','/password-visibility.js?v=209-eye-toggle','/belm-watermark.jpg'];
