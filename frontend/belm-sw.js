...
const CACHE='belm-app-v301-customer-job-billing';
const SHELL=['/customer-app.html','/customer-app.css?v=211-bug-audit','/customer-app.js?v=297-procurement-first','/password-visibility.css?v=209-eye-toggle','/password-visibility.js?v=209-eye-toggle','/belm-watermark.jpg'];
