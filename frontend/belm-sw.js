...
const CACHE='belm-app-v474-session-persistence';
...
const SHELL=['/customer-app.html','/customer-app.css?v=327-login-legal','/customer-app.js?v=474-session-persistence','/password-visibility.css?v=209-eye-toggle','/password-visibility.js?v=209-eye-toggle','/belm-watermark.jpg'];
