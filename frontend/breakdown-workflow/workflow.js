(function(){
  ...
  function renderDetail(){
    ...
    const steps=[['RECEIVED','Received'],['ASSIGNED','Assigned'],['IN_PROGRESS','In Progress'],['SPARES','Spares'],['TESTING','Testing'],['COMPLETED','Completed']];
