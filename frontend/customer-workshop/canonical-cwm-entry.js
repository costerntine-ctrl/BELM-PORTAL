...
(function () {
  ...
  style.textContent = `
    ...
    #cwmMainDashboard #cwmSettingsLink{grid-column:1/-1!important;background:linear-gradient(135deg,#617f94,#4d6f88)!important;color:#fff!important}
    #cwmMainDashboard #cwmMachinesLink{display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;min-height:76px!important;margin:16px 0 22px!important;padding:15px 62px!important;border-radius:20px!important;background:linear-gradient(135deg,#f5b900,#ffd126)!important;color:#061525!important;border:1px solid #ffe067!important;box-shadow:0 10px 20px rgba(0,0,0,.22)!important;font-size:17px!important;font-weight:950!important;text-align:center!important}
    ...
    @media(max-width:560px){#cwmMainDashboard .cwm-main-action-grid{gap:10px!important}#cwmMainDashboard .cwm-main-action-grid>a{min-height:82px!important;padding:12px 40px 12px 64px!important;font-size:14px!important}#cwmMainDashboard .cwm-action-icon{left:10px!important;width:44px!important;height:44px!important}#cwmMainDashboard #cwmMachinesLink{min-height:70px!important;font-size:15px!important}}
  `;
