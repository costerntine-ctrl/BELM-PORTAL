(function () {
  ...
  function customerRoleEntry() {
    const role = String(customerSession.customerRole || (customerSession.actorType === "owner" ? "owner" : "assistant"))
      .trim().toLowerCase();
    const entries = {
      owner: { label: "Customer Owner", href: "/general-analysis/?module=overview#overview", note: "Open Main Role Dashboard" },
      admin: { label: "Customer Admin", href: "/general-analysis/?module=overview#overview", note: "Open Main Role Dashboard" },
      workshop_manager: { label: "Workshop Manager", href: "/general-analysis/?module=workshop#workshop-analysis", note: "Open Workshop Role Activity" },
      store_keeper: { label: "Store Keeper", href: "/general-analysis/?module=store#store-analysis", note: "Open Store Role Activity" },
      procurement: { label: "Procurement", href: "/general-analysis/?module=procurement#procurement-analysis", note: "Open Procurement Analysis" },
      accounts: { label: "Accounts / Finance", href: "/general-analysis/?module=finance#finance-analysis", note: "Open Finance Role Activity" },
      operator: { label: "Machine Operator", href: "/general-analysis/?module=operator#operator-analysis", note: "Open Operator Role Activity" },
      assistant: { label: "Portal User", href: "/general-analysis/?module=overview#overview", note: "Open Assigned Role Activity" },
    };
    return entries[role] || { label: role.replaceAll("_", " ") || "Portal User", href: "/general-analysis/?module=overview#overview", note: "Open Assigned Role Activity" };
  }
