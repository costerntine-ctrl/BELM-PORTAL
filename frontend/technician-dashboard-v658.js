(()=>{
  ...
  async function openReports(machine){
    ...
    try{
      ...
      body.querySelectorAll('[data-report-view]').forEach(button=>button.onclick=()=>{location.href=`/tech-report/?machineId=${encodeURIComponent(machine.id)}&category=${encodeURIComponent(button.dataset.reportView)}`});
