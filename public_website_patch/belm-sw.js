...
const CACHE='belm-app-v351-free-reedit-dev-customer-expenses';self.addEventListener('install',e=>{self.skipWaiting()});self.addEventListener('activate',e=>e.waitUntil(self.clients.claim()));
