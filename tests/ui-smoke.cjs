...
(async () => {
  ...
  console.log("BELM UI smoke tests passed: original role login routes, managers, settings, approvals, customer links, role isolation, All Overview navigation, reports, attendance, and sidebar access.");
})().catch((error) => {
  console.error(error);
  process.exitCode = 1;
});
