...
test('empty received list has explicit state',bwJs.includes('No received Job Cards waiting for dispatch')&&bwJs.includes('No received Job Cards for this customer'));
