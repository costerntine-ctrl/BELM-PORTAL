...
test('changed admin assets are cache-busted',/admin-sidebar\.js\?v=(320-engineering-single-owner|357-az-refresh-motion|359-my-c-sidebar|361-my-c-customer-details)/.test(engHtml)&&engHtml.includes('/engineering-manager/manager.js?v=320-engineering-single-owner')&&/breakdown-workflow\/workflow\.js\?v=(320-engineering-single-owner|326-jc-proforma-sync|328-assigned-job-card-select|329-action-feedback-reset)/.test(workflowHtml)&&/customers-manager\/manager\.js\?v=(320-engineering-single-owner|351-dev-expense-access|352-public-url-port-guard|360-customer-card-cleanup|362-my-c-quick-actions|365-single-procurement-main-card|366-machine-card-no-edit-delete|368-customer-contact-lines|371-customer-quick-buttons|373-manage-customer|376-machine-actions-one-row|377-admin-machine-management|377-admin-machine-management-activity-status)/.test(customersHtml));
