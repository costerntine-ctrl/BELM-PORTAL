...
test('changed admin assets are cache-busted',engHtml.includes('/admin-sidebar.js?v=320-engineering-single-owner')&&engHtml.includes('/engineering-manager/manager.js?v=320-engineering-single-owner')&&/breakdown-workflow\/workflow\.js\?v=(320-engineering-single-owner|326-jc-proforma-sync|328-assigned-job-card-select)/.test(workflowHtml)&&customersHtml.includes('/customers-manager/manager.js?v=320-engineering-single-owner'));
