...
t('service worker and health keep V339-or-later build identity',/const CACHE='belm-app-v(?:339-dispatch-machine-sync|340-customer-login-blue|341-proforma-invoice-direct-sync|342-technician-job-card-visibility|353-web-db-availability)'/.test(sw)&&/\'schemaVersion\' => \'(?:339-dispatch-machine-sync|340-customer-login-blue|341-proforma-invoice-direct-sync|342-technician-job-card-visibility|353-web-db-availability-decoupling)\'/.test(health));
