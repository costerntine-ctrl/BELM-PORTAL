...
t('service worker and health keep V339-or-later build identity',/const CACHE='belm-app-v(?:339-dispatch-machine-sync|340-customer-login-blue)'/.test(sw)&&/\'schemaVersion\' => \'(?:339-dispatch-machine-sync|340-customer-login-blue)\'/.test(health));
