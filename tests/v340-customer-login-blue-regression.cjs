...
const checks = [
  ['V360 intentionally removes customer-card login anchor', !js.includes('>Open customer login</a>')],
  ...
  ['customer manager css cache bumped', /manager\.css\?v=(?:340-customer-login-blue|367-communication-history-fit|368-customer-contact-lines)/.test(html)],
  ['unchanged manager js retains compatible cache label', /manager\.js\?v=(320-engineering-single-owner|351-dev-expense-access|352-public-url-port-guard|360-customer-card-cleanup|362-my-c-quick-actions|365-single-procurement-main-card|366-machine-card-no-edit-delete|368-customer-contact-lines)/.test(html)],
