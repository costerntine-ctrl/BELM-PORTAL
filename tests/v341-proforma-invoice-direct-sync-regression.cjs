...
['generated invoice re-edit remains available in current release',!billing.includes('commercial lines are locked')&&billing.includes('source_proforma_id remains as traceability only')],
['proforma re-edit remains available after invoice in current release',!proforma.includes('This Proforma already generated Invoice')&&proforma.includes('Re-edit stays available even after this Proforma generated an Invoice')],
