...
t('V355 health schema marker active',index.includes("'schemaVersion' => '355-json-api-clean-response'")||index.includes("'schemaVersion' => '356-bank-test-reset'"));
t('V355 migration release active',migrate.includes("const BELM_RELEASE = '355-json-api-clean-response';")||migrate.includes("const BELM_RELEASE = '356-bank-test-reset';"));
...
t('service worker cache is V355',sw.includes("const CACHE='belm-app-v355-json-api-clean-response';")||sw.includes("const CACHE='belm-app-v356-bank-test-reset';"));
