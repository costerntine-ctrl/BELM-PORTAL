...
const checks = [
  ...
  ['Four-column single row layout exists', /grid-template-columns:\s*repeat\(4,\s*minmax\(0,\s*1fr\)\)/.test(css)],
  ...
  ['Asset cache-bust updated', /v=371-customer-quick-buttons/.test(html)],
